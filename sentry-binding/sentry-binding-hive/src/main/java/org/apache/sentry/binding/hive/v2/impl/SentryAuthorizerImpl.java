 ...
 * {@link SentryAccessController} and {@link SentryAuthorizationValidator} to constructor.
 *
 */
public class SentryAuthorizerImpl implements HiveAuthorizer {
  SentryAccessController accessController;
  SentryAuthorizationValidator authValidator;

   public SentryAuthorizerImpl(SentryAccessController accessController,
       SentryAuthorizationValidator authValidator) {
