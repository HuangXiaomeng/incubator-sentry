...
import org.apache.hadoop.hive.ql.plan.PrivilegeObjectDesc.PrivilegeObjType;
...
public class SentryAuthorizationTaskFactoryImplV2 extends HiveAuthorizationTaskFactoryImpl {
  ...
  @Override
  protected List<PrivilegeObjType> getSupportedPrivilegeTypes() {
    return Lists.newArrayList(PrivilegeObjType.Global, PrivilegeObjType.Database,
        PrivilegeObjType.Table, PrivilegeObjType.Uri);
  }
