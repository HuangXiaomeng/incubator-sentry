...
public class TestSentryStore {
  ...
  public void testGrantRevokeMultiPrivileges() throws Exception {
    ...
    assertEquals(seqId + 1, sentryStore.alterSentryRoleGrantPrivileges(roleName, tPrivileges)
        .getSequenceId());
    MSentryRole role = sentryStore.getMSentryRoleByName(roleName);
    Set<MSentryPrivilege> privileges = role.getPrivileges();
    ...
    assertEquals(seqId + 2, sentryStore.alterSentryRoleRevokePrivileges(roleName, tPrivileges)
        .getSequenceId());
    role = sentryStore.getMSentryRoleByName(roleName);
    privileges = role.getPrivileges();
  ...
  public void testDropTableWithColumn() throws Exception {
    ...
    sentryStore.alterSentryRoleGrantPrivilege(roleName1, privilege_tbl1_c1);
    sentryStore.alterSentryRoleGrantPrivilege(roleName1, privilege_tbl1_c2);
    sentryStore.alterSentryRoleGrantPrivilege(roleName2, privilege_tbl1_c3);
